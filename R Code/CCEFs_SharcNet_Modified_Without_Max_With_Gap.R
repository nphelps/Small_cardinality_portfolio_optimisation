...
write.csv(df, paste0("Modified CCEF - Without Max - With Gap - Port ", port_number, ".csv"), row.names = F)
write.csv(timeData, paste0("Time - Modified CCEF - Without Max - With Gap - Port ", port_number, ".csv"), row.names = F)
write.csv(numEFData, paste0("Number of Sub-EFs - Modified CCEF - Without Max - With Gap - Port ", port_number, ".csv"), row.names = F)
